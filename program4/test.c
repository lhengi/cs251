...
int main(int argc, char *argv[]) {
 ...
 printf("Top var: id: %d\tpriority: %lf\n",id,priority);
 pq_delete_top(pq, &id, &priority);
 printf("Top var: id: %d\tpriority: %lf\n",id,priority);
 display_heap(pq);
 printf("Change priority\n");
 pq_change_priority(pq, 3, 20);
 display_heap(pq);
 
 printf("\n\ntesting get priority\n");
 pq_get_priority(pq,3 , &priority);
 printf("get prio:\tID: %d, priority: %lf\n",3,priority);
 
 
 pq_remove_by_id(pq, 13);
 int i;
